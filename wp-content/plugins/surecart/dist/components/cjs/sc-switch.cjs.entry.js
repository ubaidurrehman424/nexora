...
const ScSwitch = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: 'fa511c92f139c3ace508bacb3d08c86a1631201f', part: "base", htmlFor: this.switchId, class: {
                'switch': true,
            ...
            }, onMouseDown: e => this.handleMouseDown(e) }, index.h("span", { key: '04c4946bbd3a5449af44495d564e7af9044e87dd', part: "control", class: "switch__control" }, index.h("span", { key: '652c942b9c83cf39ecc31db86bd95b45cb60d488', part: "thumb", class: "switch__thumb" }), index.h("input", { key: 'e6a471cb3be5001609d103ba575dbb3f2bd07eaf', ref: el => (this.input = el), id: this.switchId, type: "checkbox", role: "switch", name: this.name, value: this.value || 'on', checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onKeyDown: e => this.handleKeyDown(e) })), index.h("span", { key: 'f43543c47c4b2542dd4d360afda2ab9732d56def', class: "switch__label", part: "label" }, index.h("span", { key: 'b10af19f911c69fed4adfda424fdc947a7e9fcd5', part: "title", id: this.labelId, class: "switch__title" }, index.h("slot", { key: '9974eee91ca3b0de6d762cd99fe44efdd1351d21' })), index.h("span", { key: '561962b5f5c8bb6977e1e09d3037746cc6fcfda5', class: "switch__description", part: "description" }, index.h("slot", { key: '4a03d162ee1090706f72fda1c330f185d9f5c0cc', name: "description" })))));
    }
