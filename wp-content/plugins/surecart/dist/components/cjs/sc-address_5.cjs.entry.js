...
const ScAddress = class {
    constructor(hostRef) {
        ...
        this.collapsibleFieldNames = ['line_2', 'city', 'state', 'postal_code'];
        this.address = {
            country: null,
            city: null,
            line_1: null,
    ...
    toggleAddressFieldsVisibility(show) {
        this.showCity = show;
    ...
    isFieldIncluded(field) {
        ...
        switch (field.name) {
            ...
            case 'state':
                return !!((_a = this === null || this === void 0 ? void 0 : this.regions()) === null || _a === void 0 ? void 0 : _a.length) && !!((_b = this === null || this === void 0 ? void 0 : this.address) === null || _b === void 0 ? void 0 : _b.country);
            case 'line_2':
                ...
                if (!this.isFieldsExpanded())
                    return true;
                return this.showLine2 || !!((_d = (_c = this === null || this === void 0 ? void 0 : this.address) === null || _c === void 0 ? void 0 : _c.line_2) === null || _d === void 0 ? void 0 : _d.length);
            default:
                return true;
        }
    }
    renderField(field, roundedProps, isRequired) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w;
        switch (field.name) {
            case 'country':
                return (index.h("sc-select", { exportparts: "base:select__base, input, form-control, label, help-text, trigger, panel, caret, search__base, search__input, search__form-control, menu__base, spinner__base, empty", part: "name__input", value: (_b = (_a = this.address) === null || _a === void 0 ? void 0 : _a.country) !== null && _b !== void 0 ? _b : '', onScChange: (e) => {
                        var _a;
                        if (e.target.value === ((_a = this.address) === null || _a === void 0 ? void 0 : _a.country))
                            return;
                        this.clearAddress();
                        this.updateAddress({ country: e.target.value });
                    }, choices: this.countryChoices, autocomplete: 'country-name', placeholder: field.label, name: (_c = this.names) === null || _c === void 0 ? void 0 : _c.country, search: true, unselect: false, disabled: this.disabled, required: isRequired, "aria-label": field.label, ...roundedProps }));
            case 'name':
                return (index.h("sc-input", { exportparts: "base:input__base, input, form-control, label, help-text", value: (_e = (_d = this === null || this === void 0 ? void 0 : this.address) === null || _d === void 0 ? void 0 : _d.name) !== null && _e !== void 0 ? _e : '', onScChange: (e) => this.updateAddress({ name: e.target.value || null }), onScInput: (e) => this.handleAddressInput({ name: e.target.value || null }), autocomplete: "name", placeholder: field.label, name: (_f = this.names) === null || _f === void 0 ? void 0 : _f.name, disabled: this.disabled, required: this.requireName, "aria-label": field.label, ...roundedProps }));
            case 'line_1':
                return (index.h("sc-address-suggestions", { address: this.address, names: this.names, regions: this.regions(), label: field.label, disabled: this.disabled, required: isRequired, inputProps: roundedProps, onScChangeAddress: (e) => this.updateAddress(e.detail), onScShowAddressFields: () => this.toggleAddressFieldsVisibility(true), onScHideAddressFields: () => this.toggleAddressFieldsVisibility(false) }));
            case 'line_2':
                return (index.h("sc-input", { exportparts: "base:input__base, input, form-control, label, help-text", value: (_h = (_g = this === null || this === void 0 ? void 0 : this.address) === null || _g === void 0 ? void 0 : _g.line_2) !== null && _h !== void 0 ? _h : '', onScChange: (e) => this.updateAddress({ line_2: e.target.value || null }), onScInput: (e) => this.handleAddressInput({ line_2: e.target.value || null }), autocomplete: "address-line2", placeholder: field.label, name: (_j = this.names) === null || _j === void 0 ? void 0 : _j.line_2, disabled: this.disabled, "aria-label": field.label, ...roundedProps }));
            case 'city':
                return (index.h("sc-input", { exportparts: "base:input__base, input, form-control, label, help-text", placeholder: field.label, name: (_k = this.names) === null || _k === void 0 ? void 0 : _k.city, value: (_m = (_l = this === null || this === void 0 ? void 0 : this.address) === null || _l === void 0 ? void 0 : _l.city) !== null && _m !== void 0 ? _m : '', onScChange: (e) => this.updateAddress({ city: e.target.value || null }), onScInput: (e) => this.handleAddressInput({ city: e.target.value || null }), autocomplete: 'address-level2', required: isRequired, disabled: this.disabled, "aria-label": field.label, ...roundedProps }));
            case 'state':
                return (index.h("sc-select", { exportparts: "base:select__base, input, form-control, label, help-text, trigger, panel, caret, search__base, search__input, search__form-control, menu__base, spinner__base, empty", placeholder: field.label, name: (_o = this.names) === null || _o === void 0 ? void 0 : _o.state, autocomplete: 'address-level1', value: (_q = (_p = this === null || this === void 0 ? void 0 : this.address) === null || _p === void 0 ? void 0 : _p.state) !== null && _q !== void 0 ? _q : '', onScChange: (e) => { var _a; return this.updateAddress({ state: e.target.value || ((_a = e.detail) === null || _a === void 0 ? void 0 : _a.value) || null }); }, choices: this.regions(), required: isRequired, disabled: this.disabled, search: true, "aria-label": field.label, ...roundedProps }));
            case 'postal_code':
                return (index.h("sc-input", { exportparts: "base:input__base, input, form-control, label, help-text", placeholder: field.label, name: (_r = this.names) === null || _r === void 0 ? void 0 : _r.postal_code, onScChange: (e) => this.updateAddress({ postal_code: e.target.value || null }), onScInput: (e) => this.handleAddressInput({ postal_code: e.target.value || null }), autocomplete: 'postal-code', required: isRequired, value: (_t = (_s = this === null || this === void 0 ? void 0 : this.address) === null || _s === void 0 ? void 0 : _s.postal_code) !== null && _t !== void 0 ? _t : '', disabled: this.disabled, maxlength: ((_u = this.address) === null || _u === void 0 ? void 0 : _u.country) === 'US' ? 5 : undefined, pattern: ((_v = this.countryDetails) === null || _v === void 0 ? void 0 : _v.postal_code_regex) || undefined, customValidity: ((_w = this.countryDetails) === null || _w === void 0 ? void 0 : _w.postal_code_regex) ? wp.i18n.__('Please enter a valid postal code', 'surecart') : undefined, "aria-label": field.label, ...roundedProps }));
            default:
                return null;
        }
    }
    render() {
        var _a;
        const allFields = ((_a = this.sortedFields()) !== null && _a !== void 0 ? _a : []).filter(field => this.isFieldIncluded(field));
        ...
        return (index.h("div", { key: '17feedd1eaaecdc6e578a47eb9c800e1ef5802df', class: "sc-address", part: "base" }, index.h("sc-form-control", { key: '7f82dd63794c37a6283a74b58798143a546dfb06', label: this.label, exportparts: "label, help-text, form-control", class: "sc-address__control", required: this.required }, topFields.map((field, index) => {
            const roundedProps = this.getRoundedProps(index, totalForRounding);
            return this.renderField(field, roundedProps, this.required);
        }), index.h("div", { key: '0897ee72c5f97309329c937006e465a0d3972a79', class: {
        ...
        }))), this.loading && index.h("sc-block-ui", { key: 'd9374bb372c79bf14adad4da65f71cf7fb97f017', exportparts: "base:block-ui, content:block-ui__content" })));
    }
...
const escapeHtml = (s) => s.replace(/[&<>"']/g, c => HTML_ESCAPE_MAP[c]);
 ...
 */
function buildReplacementAddressFromPlace(place, regions, previousName) {
    ...
    return {
        ...
        line_1: line1,
        line_2: (_b = placeDetails.line_2) !== null && _b !== void 0 ? _b : null,
        city: (_c = placeDetails.city) !== null && _c !== void 0 ? _c : null,
        state: (_d = placeDetails.state) !== null && _d !== void 0 ? _d : null,
        postal_code: (_e = placeDetails.postal_code) !== null && _e !== void 0 ? _e : null,
        country: (_f = placeDetails.country) !== null && _f !== void 0 ? _f : null,
    };
}
/**
 * Fetches place details from the Google Maps API.
 */
async function fetchPlaceDetails(placeId, addressSuggestions, address$1, regions) {
    var _a;
...
const ScAddressSuggestions = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.scChangeAddress = index.createEvent(this, "scChangeAddress", 7);
        this.scShowAddressFields = index.createEvent(this, "scShowAddressFields", 7);
        this.scHideAddressFields = index.createEvent(this, "scHideAddressFields", 7);
        var _a;
        ...
        this.debouncedFetchAddressSuggestions = lodash.exports.debounce(async (input) => {
            ...
            try {
                ...
                if ((error === null || error === void 0 ? void 0 : error.name) === 'AbortError')
                    return;
                mutations.createErrorNotice({
                    message: wp.i18n.sprintf(wp.i18n.__('Google Map Error: %s', 'surecart'), error.message),
                });
        ...
        this.label = wp.i18n.__('Address', 'surecart');
        this.inputProps = {};
        this.disabled = false;
        this.required = true;
        this.value = ((_a = this.address) === null || _a === void 0 ? void 0 : _a.line_1) || '';
        this.regions = [];
        this.addressSuggestions = [];
        this.showSuggestions = false;
        this.loading = false;
    ...
    isGoogleMapsActive() {
        var _a;
        return !!((_a = window === null || window === void 0 ? void 0 : window.scData) === null || _a === void 0 ? void 0 : _a.google_map_api_key);
    }
    handleValueChange(newValue) {
        var _a;
        // Only fetch suggestions for user input, not prop syncs.
        if (!this.hasUnsyncedLocalValue)
            return;
        if (!((_a = this.address) === null || _a === void 0 ? void 0 : _a.country))
            return;
    ...
    async selectSuggestion(placeId) {
        var _a;
    ...
    handleInputChange(e) {
        ...
        this.hasUnsyncedLocalValue = !!((_a = e.target) === null || _a === void 0 ? void 0 : _a.value);
        this.value = (_b = e.target) === null || _b === void 0 ? void 0 : _b.value;
    }
    ...
    handleInputValueChange(e) {
        ...
        if (newValue && newValue !== ((_b = this.address) === null || _b === void 0 ? void 0 : _b.line_1)) {
            this.hasUnsyncedLocalValue = false;
            this.closeSuggestionsDropdown();
    ...
    updateFieldVisibility() {
        var _a;
        if (!this.isGoogleMapsActive())
            return; // Not our concern — parent shows all fields.
        const hasValue = ((_a = this.address) === null || _a === void 0 ? void 0 : _a.line_1) || (this.hasUnsyncedLocalValue && this.value);
        if (hasValue) {
            this.scShowAddressFields.emit();
        }
        else {
    ...
    getSuggestionsStatusText() {
        if (!this.showSuggestions || !this.value)
            return '';
        if (this.loading)
            return wp.i18n.__('Loading suggestions...', 'surecart');
        if (this.addressSuggestions.length === 0)
            return wp.i18n.__('No suggestions found', 'surecart');
        ...
        if (this.focusedIndex >= 0 && this.addressSuggestions[this.focusedIndex]) {
            ...
            wp.i18n.__('%1$s, %2$d of %3$d. Press Enter to select.', 'surecart'), this.addressSuggestions[this.focusedIndex].fullDisplayName, this.focusedIndex + 1, this.addressSuggestions.length);
        }
        return wp.i18n.sprintf(wp.i18n.__('%d suggestions available', 'surecart'), this.addressSuggestions.length);
    }
    ...
    renderAddressSuggestions() {
        ...
        return (index.h("div", { class: "sc-address__suggestions--body" }, index.h("div", { class: "sc-address__suggestions--scroll" }, index.h("ul", { class: "sc-address__suggestions--list", part: "suggestions-list", role: "listbox", id: "address-suggestions-listbox" }, index.h("li", { class: "sc-address__suggestions--item sc-address__suggestions--item--no-select sc-address__suggestions--item--powered-by", part: "suggestion-item powered-by", role: "presentation", tabindex: "-1" }, index.h("span", null, wp.i18n.__('Suggestions powered by ', 'surecart'), index.h("a", { href: "https://policies.google.com/privacy", target: "_blank", rel: "noopener noreferrer", "aria-label": wp.i18n.__('Google Privacy Policy (opens in new tab)', 'surecart') }, index.h("span", null, wp.i18n.__('Google', 'surecart')))), index.h("sc-button", { type: "text", onMouseDown: e => e.preventDefault(), onClick: () => {
                this.showSuggestions = false;
                this.addressSuggestions = [];
            }, "aria-label": wp.i18n.__('Close suggestions', 'surecart') }, index.h("sc-icon", { name: "x", style: { color: 'var(--sc-color-gray-500)' } }))), this.loading && this.addressSuggestions.length === 0 && (index.h("li", { class: "sc-address__suggestions--item sc-address__suggestions--item--no-select sc-address__suggestions--item--no-result", part: "suggestion-item no-result", role: "presentation", tabindex: "-1" }, wp.i18n.__('Loading...', 'surecart'))), !this.loading && this.addressSuggestions.length === 0 && (index.h("li", { class: "sc-address__suggestions--item sc-address__suggestions--item--no-select sc-address__suggestions--item--no-result", part: "suggestion-item no-result", role: "presentation", tabindex: "-1" }, wp.i18n.__('No results found', 'surecart'))), this.addressSuggestions.map((suggestion, index$1) => (index.h("li", { id: `suggestion-${index$1}`, class: {
                'sc-address__suggestions--item': true,
                'focused': this.focusedIndex === index$1,
            }, part: "suggestion-item", role: "option", "aria-selected": this.focusedIndex === index$1 ? 'true' : 'false', "aria-label": wp.i18n.sprintf(wp.i18n.__('Select suggestion %s', 'surecart'), suggestion.fullDisplayName), tabindex: "-1", onMouseDown: e => e.preventDefault(), onClick: () => this.selectSuggestion(suggestion === null || suggestion === void 0 ? void 0 : suggestion.placeId), innerHTML: highlightMatch(suggestion.fullDisplayName, this.value), onMouseEnter: () => (this.focusedIndex = index$1), onMouseLeave: () => (this.focusedIndex = -1) }))))), index.h("div", { class: "sc-address__suggestions--footer", part: "suggestion-item manually", role: "presentation" }, index.h("button", { type: "button", onMouseDown: e => e.preventDefault(), onClick: () => this.manualAddress(), "aria-label": wp.i18n.__('Enter address manually instead of using suggestions', 'surecart') }, wp.i18n.__('Enter address manually', 'surecart')))));
    }
    render() {
        var _a;
        const suggestionsVisible = this.isSuggestionsVisible();
        return (index.h("div", { key: '51373d867eb805855e95c97980187e9856faadb1', part: "base" }, this.isGoogleMapsActive() && index.h("span", { key: 'c50f3e49a1e759582cd7febe40b930bb88cb2705', class: "sr-only" }, wp.i18n.__('Start typing to see address suggestions, or select one to auto-fill your address.', 'surecart')), index.h("sc-input", { key: '6ca068c4efa0d4133ffe1f1ed61907e4514b1954', exportparts: "base:input__base, input, form-control, label, help-text", value: this === null || this === void 0 ? void 0 : this.value, onScInput: (e) => this.handleInputChange(e), onScChange: (e) => this.handleInputValueChange(e), autocomplete: "address-line1", placeholder: this.label, "aria-label": this.label, "aria-expanded": suggestionsVisible ? 'true' : 'false', "aria-controls": suggestionsVisible ? 'address-suggestions-listbox' : undefined, "aria-activedescendant": this.getActiveDescendantId(), role: "combobox", name: (_a = this.names) === null || _a === void 0 ? void 0 : _a.line_1, disabled: this.disabled, required: this.required, ...this.inputProps }), index.h("div", { key: 'bd15a6d7982bb6b0c0946ebd58089f8e096a98dd', role: "status", "aria-live": "polite", "aria-atomic": "true", class: "sr-only" }, this.getSuggestionsStatusText()), index.h("div", { key: '2c0bc837d1c135a5d94182a2748b993bcce40cd9', class: {
...
ScAddressSuggestions.style = ScAddressSuggestionsStyle0;
...
const ScCheckbox = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: '91f52adc16eb2a29deb822f9cb33981e31580135', part: "base", class: {
                'checkbox': true,
...
const ScPhoneInput = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '575bab47a7395c42a5b13dfcd7b51d1959f10362', hidden: this.hidden }, index.h("sc-form-control", { key: 'cbb1abe87c520df93e581dc610abbe9d87c16d1c', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name, "aria-label": this.label }, index.h("slot", { key: 'f4ec8639e38f6fada53617f5ab86c25c999bf541', name: "label-end", slot: "label-end" }), index.h("div", { key: '04c1acfe0ddc763bff7fa84cfb061b63af1e34e2', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, index.h("span", { key: 'f0ec601739a818b44c905cc9ab3bf6406a336e24', part: "prefix", class: "input__prefix" }, index.h("slot", { key: '7c29784c481d424c49f51fe92f2ce0e415025ca3', name: "prefix" })), index.h("slot", { key: '2feca25a2fb6c59ca163a1db0e5ef8cb47369d28' }, index.h("input", { key: '9fccc9fa0e4a428576f774bc0717527f0c786080', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: "tel", name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            // TODO: Test These below
            autocomplete: 'tel', autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, pattern: index$1.applyFilters('surecart/sc-phone-input/pattern', this.pattern), inputmode: 'numeric', "aria-label": this.label, "aria-labelledby": this.label, "aria-invalid": this.invalid ? true : false, value: this.value, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() })), index.h("span", { key: 'a42d7a6081b27b1dd84a60589bd076c9cd04884d', part: "suffix", class: "input__suffix" }, index.h("slot", { key: '42d6fdbef3825c9f2c1219aa5a8d4ac95c357a35', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("button", { key: 'f690b1affd06d483e472e1a612f443c3a5c476bf', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, index.h("slot", { key: 'afbbf98a372e2bf4dbaf03e527cac6f59d2a9f97', name: "clear-icon" }, index.h("svg", { key: '600a51c41c0badefedb6716236d63e872dfe3c99', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, index.h("line", { key: '261601725be31bb947796023caf24f7779d63923', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: 'de411911a88ebb871866b775fc6a768901dca5f6', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
