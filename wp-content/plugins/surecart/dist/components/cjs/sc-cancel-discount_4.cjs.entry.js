...
const ScCancelDiscount = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0704523769c1e11ff0435d42a95cabbdf97cf596', class: "cancel-discount" }, index.h("sc-dashboard-module", { key: '829dacc1acb189206d0c2341341c5f91d63de9bb', heading: title, style: { '--sc-dashboard-module-spacing': '2em' } }, index.h("span", { key: 'c16584211ee2369a1b3668cba3a236a6c60cfcbf', slot: "description" }, description), index.h("sc-flex", { key: '66b07e0ff2e049e5323db33b6ac6d00448acd7c5', justifyContent: "flex-start" }, index.h("sc-button", { key: 'd0de2d64693dad825899939be479dfb5cdc472cc', type: "primary", onClick: () => this.addDiscount() }, button), index.h("sc-button", { key: '1fc4c09971e02fcac32c317f0846d87f318797aa', class: "cancel-discount__abort-link", type: "text", onClick: () => this.scCancel.emit() }, cancel_link)), !!this.loading && index.h("sc-block-ui", { key: 'a79227d8c5a5840f61107abd7b02d28de624520f', spinner: true }))));
    }
};
...
const ScSubscriptionCancel = class {
    ...
    render() {
        ...
        return (index.h("sc-dashboard-module", { key: '644b8be5d181d64065a4960679ee2aa0ef3e69b5', heading: heading, class: "subscription-cancel", error: this.error, style: { '--sc-dashboard-module-spacing': '1em' } }, index.h("div", { key: '498cc3f71eb15cd206b9c775aefe3fa5aaf43652', slot: "description" }, content, index.h("slot", { key: '2389efa6b3e96f60d67b355832124bbc53f799bc', name: "cancel-popup-content" })), index.h("sc-flex", { key: 'c41ae136763c81180de723ae9d573a52467d09ba', justifyContent: "flex-start" }, index.h("sc-button", { key: '67118ba26f024f1f0ad8a3bc31c33c4317027b87', type: "primary", loading: this.loading || this.busy, disabled: this.loading || this.busy, onClick: () => this.cancelSubscription() }, cancelButtonText), index.h("sc-button", { key: '0beb56b97273e5cb0a2191a204a298a1bc437c9c', type: "text", onClick: () => this.scAbandon.emit(), loading: this.loading || this.busy, disabled: this.loading || this.busy }, keepButtonText)), this.busy && index.h("sc-block-ui", { key: 'c7a5e5f1ce4fb10c5930e863e3cc73d2776cfa67' })));
    }
};
...
const ScTextarea = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'ebc176da622e4a7dbdf01b60e429eb5cffb8bc30', part: "form-control", class: {
                'form-control': true,
                'form-control--small': this.size === 'small',
                'form-control--medium': this.size === 'medium',
                'form-control--large': this.size === 'large',
            } }, index.h("sc-form-control", { key: '2ff8fa53f02ab917cdc331a684f8695d576cbe46', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: 'f4de0cc5295cfbb1e1b040bb7501bde4e7b93e75', part: "form-control-input", class: "form-control-input" }, index.h("div", { key: 'bdf6bc8f3a7be510d34fda8b0401f98edf93a008', part: "base", class: {
                'textarea': true,
