...
const ScPriceChoiceContainerStyle0 = scPriceChoiceContainerCss;
...
const ScPriceChoiceContainer = class {
    ...
    renderPrice() {
        var _a;
        return (index.h(index.Fragment, null, (_a = this.priceData) === null || _a === void 0 ? void 0 :
            _a.display_amount, price.intervalString(this.priceData, {
            showOnce: true,
            abbreviate: true,
            labels: {
                interval: '/',
    ...
    render() {
        ...
        }))))), !!((_f = this.priceData) === null || _f === void 0 ? void 0 : _f.trial_duration_days) && (index.h(index.Fragment, null, index.h("sc-visually-hidden", null, wp.i18n.sprintf(wp.i18n.__('You have a %d-day trial before payment becomes necessary.', 'surecart'), (_g = this.priceData) === null || _g === void 0 ? void 0 : _g.trial_duration_days)), index.h("div", { class: "price-choice__trial", "aria-hidden": "true" }, wp.i18n.sprintf(wp.i18n._n('Starting in %s day', 'Starting in %s days', this.priceData.trial_duration_days, 'surecart'), this.priceData.trial_duration_days)))), !!((_h = this.priceData) === null || _h === void 0 ? void 0 : _h.setup_fee_enabled) && ((_j = this.priceData) === null || _j === void 0 ? void 0 : _j.setup_fee_amount) && (index.h("div", { class: "price-choice__setup-fee" }, index.h("sc-visually-hidden", null, wp.i18n.__('This payment plan has', 'surecart'), " "), (_k = this.priceData) === null || _k === void 0 ? void 0 :
            _k.setup_fee_display_amount, ' ', ((_l = this.priceData) === null || _l === void 0 ? void 0 : _l.setup_fee_name) || (((_m = this.priceData) === null || _m === void 0 ? void 0 : _m.setup_fee_amount) < 0 ? wp.i18n.__('Discount', 'surecart') : wp.i18n.__('Setup Fee', 'surecart')))))))));
    }
    static get watchers() { return {
        "price": ["handlePriceChange"]
    }; }
};
ScPriceChoiceContainer.style = ScPriceChoiceContainerStyle0;
