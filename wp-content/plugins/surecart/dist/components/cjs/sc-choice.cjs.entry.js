...
const ScChoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '268e9e57a489f4aba6c827563548622e6be9c1f9', tabindex: "0", onFocus: () => this.input.focus() }, index.h("div", { key: '6942882e76adb24753eae16a9d7bc7cfd726dd63', part: "base", class: {
                'choice': true,
            ...
            }, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("slot", { key: '3ee33239d9e991b5d867fb08da0579ed48906e9c', name: "header" }), index.h("label", { key: '951101cae57f06dadfd7a5c784a5a96db46b7a48', class: "choice__content", part: "content", htmlFor: this.inputId }, index.h("span", { key: 'e574424da7f8b381b8148b747d407d86b9d6eb61', part: "control", class: {
                choice__control: true,
                choice__checkbox: this.type === 'checkbox',
                choice__radio: this.type === 'radio',
            }, hidden: !this.showControl }, index.h("span", { key: '15c7d27afead0cfd9f72b440794263fc1e3268e9', part: "checked-icon", class: "choice__icon" }, this.type === 'checkbox' ? (index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(3.428571, 3.428571)" }, index.h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), index.h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" })))))) : (index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { fill: "currentColor" }, index.h("circle", { cx: "8", cy: "8", r: "3.42857143" })))))), index.h("input", { key: '91874ea93c9cfdebaff26bef3ca8ce79f1803cb6', id: this.inputId, ref: el => (this.input = el), type: this.type, name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, tabindex: "0",
            // required={this.required}
            onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleClickEvent() })), index.h("span", { key: '881e2fa2cf520852b7efcbbdb95b2c11c53276dd', part: "label", id: this.labelId, class: "choice__label" }, index.h("span", { key: '032ddbc1ca1c9e3fb8390c97063753a6956fbc8f', class: "choice__label-text", hidden: !this.showLabel }, index.h("span", { key: 'fb7c71c2519e8e286e077fe2f1b7f6226ac4a69c', class: "choice__title", part: "title" }, index.h("slot", { key: 'ac0da72d58d5eba43c64ed6e8a66add65e5b64b1', onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: '6f8225a6432c1c531c4ea92ac45a189f8641a116', class: "choice__description description", part: "description", hidden: !this.hasDescription }, index.h("slot", { key: '4434343268db4bda5924188a050b0947e553dd40', name: "description", onSlotchange: () => this.handleSlotChange() }))), index.h("span", { key: '42a3dc5c7f1cc3097e356195a1aac60b832b9cea', class: "choice__price", hidden: !this.showPrice || (!this.hasPrice && !this.hasPer) }, index.h("span", { key: 'd863b0eb3133587d03d852c806faaa6dbcf2dc7b', class: "choice__title" }, index.h("slot", { key: '5efd5ffa4a94b19583d581d242c412fac19fba26', name: "price", onSlotchange: () => this.handleSlotChange() })), ' ', index.h("span", { key: 'dfdd70f98262532ae271535df1933d3948aa30df', class: "choice__description" }, index.h("slot", { key: '20c89005409d2ccb6245a8027096d79425cdc0e6', name: "per", onSlotchange: () => this.handleSlotChange() }))))), index.h("slot", { key: '46e569251603c3c40c7e394691df6ec4d35f9170', name: "footer" }))));
    }
