...
const ScChoices = class {
    ...
    render() {
        return (index.h("fieldset", { key: '249754a70de15420a7e037d1be742fe9e2594cda', part: "base", class: {
                'choices': true,
            ...
            }, role: "radiogroup" }, index.h("sc-form-control", { key: '227b03cd4632a7dec8503d9a7548a9b3f88aa857', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId }, index.h("div", { key: '00b20cf3595a85e18e1102eb4921e9feb390e993', part: "choices", class: "choices__items" }, index.h("slot", { key: 'da19d8a64f18609bb79ec827c3ffdd4097a7007b' })))));
    }
