...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (index.h(index.Host, { key: '115ac3b2ac24d79a95eae9bc7721207ed346c4ee' }, index.h("sc-form-control", { key: '968903c6c1bf9edd82a8e1a336169dedd056cf34', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: 'b27536076592667b9c455947b1325c86f4aa8874', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, index.h("div", { key: '6d963f88d4bde4472fa647c24afecb361dd6c2f4', class: "menu" }, index.h("sc-button", { key: '22974ad1b4913c0801a7338e3ca34b761909592b', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, index.h("sc-icon", { key: 'e99a658957764c51b2650ccc290ead4d388c0fd2', name: "bold" })), index.h("sc-button", { key: 'e097bf05d4301d92287e9dafe56c23d6225d1e43', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, index.h("sc-icon", { key: '806673a29479c69e90a66dcb0cf4f47d56ab9e66', name: "italic" })), index.h("sc-button", { key: '82cad2454ef10a019c8727f9c1d3881969214182', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, index.h("sc-icon", { key: 'a7d5a459f8b37307d067c21a73ccd2e6c059d7e6', name: "list" })), index.h("sc-button", { key: '19ba79abc57d3ef3a20b51330740fbe762f47141', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, index.h("sc-icon", { key: '0cbe0ffecacf5ccb02e8079f21ef30765bc509c1', name: "minus" })), index.h("sc-button", { key: '1f1d266175172d39496fb7ec524b12ce7e3ee4d2', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, index.h("sc-icon", { key: '98d89b063a94cf98c1c41c5e7a3143dbbd8e13fe', name: "corner-up-left" })), index.h("sc-button", { key: '8446d174a1057eda67234f51fbcfe10610887b7b', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, index.h("sc-icon", { key: '8249db298b3caf5e1d269f4a3bb8c4a0989c39eb', name: "corner-up-right" }))), index.h("div", { key: 'f82060ccded85e712fe02b311929d197d3d3f3c0', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && index.h("div", { key: '80ea37728962571e0f4bf6fc5cd74beaf994e3fe', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
