...
const ScBlockUi = class {
    ...
    render() {
        return (index.h("div", { key: '47d01444919f4cf56caec4a8e44bc39040299f13', part: "base", class: { overlay: true, transparent: this.transparent }, style: { 'z-index': this.zIndex.toString() } }, index.h("div", { key: 'b8e4618fd20801f059523530529e3668e092eaed', class: "overlay__content", part: "content" }, index.h("slot", { key: '7c72fd1356daa2ac23adccb682a4caf4d492d17e', name: "spinner" }, !this.transparent && this.spinner && index.h("sc-spinner", { key: 'b252861722b74d8e438acec833834c9a609efc88' })), index.h("slot", { key: '62ff3d0f9d9db58f5ce5466cc29e9dacf0990605' }))));
    }
};
