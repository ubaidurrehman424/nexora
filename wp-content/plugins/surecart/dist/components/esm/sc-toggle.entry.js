...
const ScToggle = class {
    ...
    render() {
        return (h("div", { key: 'c9320c44869a759006746ec77575ea2c2cd2ac57', part: "base", class: {
                'details': true,
            ...
            } }, h("header", { key: '5f0d8d7070d5e3ee4465e5474f01f740eda5fb1c', ref: el => (this.header = el), part: "header", id: "header", class: "details__header", role: "button", "aria-expanded": this.open ? 'true' : 'false', "aria-controls": "content", "aria-disabled": this.disabled ? 'true' : 'false', tabindex: this.disabled ? '-1' : '0', onClick: () => this.handleSummaryClick(), onKeyDown: e => this.handleSummaryKeyDown(e) }, this.showControl && (h("span", { key: '50b6035e24fb42c4ba3f73f7bf992661f9475df2', part: "radio", class: "details__radio" }, h("svg", { key: 'd9ef7ace72f1cee9e6fc1cc9c81922e0a635fd73', viewBox: "0 0 16 16" }, h("g", { key: '361c0af550cfa368d452fb480b8c77db79c6aab5', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, h("g", { key: 'bca741dcd1623daa438ce9814fda8b846463142c', fill: "currentColor" }, h("circle", { key: 'ff797838e0b9bd75f59e40b9228ed01714970469', cx: "8", cy: "8", r: "3.42857143" })))))), h("div", { key: 'baf6a7be0a6314e43e8d7a2d87a9b881c9a8f49a', part: "summary", class: "details__summary" }, h("slot", { key: 'bbc47c6801b907981dd3cbc2758d465be28f297c', name: "summary" }, this.summary)), this.showIcon && (h("span", { key: 'b1ffe9eef4af59193367d13da862393296950b94', part: "summary-icon", class: "details__summary-icon" }, h("slot", { key: 'abdb5d5b29d084bae0ac46685c3b16a910cf57e3', name: "icon" }, h("sc-icon", { key: 'e4bea8e3edf7ad14652ca526bb01d8e893a86a86', name: "chevron-right" }))))), h("div", { key: '1ed7a41b283a5a25ff695e065c80531b45646f20', class: "details__body", ref: el => (this.body = el), part: "body" }, h("div", { key: '3f99e1dcc41e11b39e2182fe2801b67d70790a8a', part: "content", id: "content", class: "details__content", role: "region", "aria-labelledby": "header" }, h("slot", { key: 'b7f4e9031e6318b56c910bc7ea459a3d3dd5e6d5' })))));
    }
