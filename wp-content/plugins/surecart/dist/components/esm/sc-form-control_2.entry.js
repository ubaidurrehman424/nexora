...
const ScFormControl = class {
    ...
    render() {
        return (h("div", { key: 'e299022b7be4f404c8e35b253efcfd3d51b2dccc', part: "form-control", class: {
                'form-control': true,
            ...
            } }, h("label", { key: '93615159904baf037e35b1f79564884911f034c1', part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, h("slot", { key: 'd253d7871dc5b82aa999f2e4846b7606e46a40b0', name: "label" }, this.label), h("slot", { key: '6c9db77880bb159d6520238a6ba5f64d69bf4150', name: "label-end" }), !!this.required && (h("span", { key: '642ea7e33ee14236ca69ba264fe0f10e96631fb2', "aria-hidden": "true", class: "required" }, ' ', "*")), h("sc-visually-hidden", { key: '38fdc95f8da36960994f24635f0bc3f3aced4dc5' }, !!this.required ? wp.i18n.__('required', 'surecart') : '')), h("div", { key: '82694c015ea08fdd8bc1ef14494a08d52838bfc6', part: "input", class: "form-control__input" }, h("slot", { key: '748d86c8b0f32c1dcb13d26b7ab5036eceb2f13a' })), this.help && (h("div", { key: 'ad7a2442106adc6b5184e3ef63324cabfae82c13', part: "help-text", id: this.helpId, class: "form-control__help-text" }, h("slot", { key: '61b4fcdfdc23cdaaff72444ce86e8f168cef2929', name: "help-text" }, this.help)))));
    }
...
const ScInput = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: '49be458083dbe2913b91278cacbf16b5881f2c93', hidden: this.hidden }, h("sc-form-control", { key: 'fb0007129c8d59abebb9230afedf72eacf5a1d4f', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("slot", { key: '8ac33795e55a2c43778b3a2697610a093dace4ad', name: "label-end", slot: "label-end" }), h("div", { key: 'b1cda6f8c313f59123591bac2fc43251cd613eaa', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, h("span", { key: 'a827e64b436e22371820382e56107d17a5b50569', part: "prefix", class: "input__prefix" }, h("slot", { key: 'c4f8d056af49516a876d478660bc05a7207bd736', name: "prefix" })), h("slot", { key: '447cee71b1d1709eb355aee4bb97c00b6d3ba1fb' }, h("input", { key: '74e7afe401c865041ff1bbeaa9b3da477f645980', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: this.type === 'password' && this.isPasswordVisible ? 'text' : this.type, name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            ...
            } })), h("span", { key: '6e2f7a9808b7168bc6098dc646a5f6463e0c95e8', part: "suffix", class: "input__suffix" }, h("slot", { key: '27dbf82804a480e61462957cb5430d976ba3a70c', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (h("button", { key: '2ff0adf5e05f37b73ad272c84cce7b1ea646e872', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, h("slot", { key: '5b30550f9ac80cda8f0ba37d8514c57f1f3d1bc8', name: "clear-icon" }, h("svg", { key: 'ef64162c5c20fff9a6a2ab052742f07a448861be', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, h("line", { key: 'a58093eee171c82158d8db4ea6fd2a0aa65dec21', x1: "18", y1: "6", x2: "6", y2: "18" }), h("line", { key: 'afecb4eb8515d25c7cc017619c261decbf91ab12', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return getElement(this); }
