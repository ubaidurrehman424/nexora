...
const ScUpcomingInvoice = class {
    ...
    render() {
        return (h("div", { key: 'efe814e872b333784453ba16d3a3bf4d4360f62a', class: "upcoming-invoice" }, this.error && (h("sc-alert", { key: 'c1ccf7ab7ecf7fb3fe6f80c0517b15c92b7757e6', open: !!this.error, type: "danger" }, h("span", { key: 'eb0aafca0b094a400f480ab68504609fb194cbba', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), h(Fragment, { key: '16dad64205f83cda0c3a9eec7fb89ac3e99d4f7a' }, h("sc-dashboard-module", { key: 'a82fc24ab3ceec2853a72d11d13e30a187d0fd7f', heading: wp.i18n.__('New Plan', 'surecart'), class: "plan-preview", error: this.error }, h("sc-card", { key: '0c4b70bcbd89daaed166a37f513dec43f546087d' }, this.renderContent())), h("sc-dashboard-module", { key: '4f264c1692f5d905ee17f22744fb18c35dcb3519', heading: wp.i18n.__('Summary', 'surecart'), class: "plan-summary" }, h("sc-form", { key: 'bdbbea245f08ccbb2134d3b42f0118662e4e05b7', onScFormSubmit: () => this.onSubmit() }, h("sc-card", { key: 'dd2a89769aba1cee4f8f7e4f57d4878d93ab8d52' }, this.renderSummary()), h("sc-button", { key: 'b39a31dfb9522433d3fbdf8616abc6017f154614', type: "primary", full: true, submit: true, loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Confirm', 'surecart')))), h("sc-text", { key: 'd9e2854ad27062df0bdd91ac499800a60dd8f734', style: { '--text-align': 'center', '--font-size': 'var(--sc-font-size-small)', '--line-height': 'var(--sc-line-height-normal)' } }, h("slot", { key: '91983a80d67d5441a44ec24fa5ddbdf78e9e760c', name: "terms" }))), this.busy && h("sc-block-ui", { key: '5e9f21681ca9a21e191fa8d402b8cde49a370e4a' })));
    }
