...
const ScAlert = class {
    ...
    render() {
        return (h(Host, { key: '4e13958b6def3ccf5d01df2b3c9e2453d243aba1', style: { 'scroll-margin-top': this.scrollMargin } }, h("div", { key: '29405ec2c933c3c126876df125b8079e89e6b037', class: {
                'alert': true,
                ...
                'alert--is-rtl': isRtl()
            }, part: "base", role: "alert", "aria-live": "assertive", "aria-atomic": "true", "aria-hidden": this.open ? 'false' : 'true', hidden: this.open ? false : true, onMouseMove: () => this.handleMouseMove() }, h("div", { key: '9d595e76dad9a42f11f36bca1dda33f2786fca4e', class: "alert__icon", part: "icon" }, h("slot", { key: '59f9e68387ba3bf1a82cce8b94eacb988715af6d', name: "icon" }, this.icon())), h("div", { key: 'e8e84ce1ebcb79beaa63be289cc763ce70f3f9b5', class: "alert__text", part: "text" }, h("div", { key: 'e864be4c98cf07b90f056eb65a5f875b6403dd30', class: "alert__title", part: "title" }, h("slot", { key: 'a2ce0960dd92bb95b02cf59bece3b84cdf098b7c', name: "title" }, this.title)), h("div", { key: 'e2b4336b09c33bfe9809ff3758d8a8655157e85c', class: "alert__message", part: "message" }, h("slot", { key: 'bd08c166fec2b6d72b3201c269988c2f8b954fa3' }))), this.closable && (h("span", { key: '9dd7b07b2c334e56c6fb62499dc9adac61471ff4', part: "close", class: "alert__close", onClick: () => this.handleCloseClick() }, h("span", { key: '49a7fb801a6067c34916cc4666756d2671d7b86c', class: "sr-only" }, "Dismiss"), h("svg", { key: '3458e4c57d7ac1deb82387c722c0656551854490', class: "h-5 w-5", "x-description": "Heroicon name: solid/x", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true" }, h("path", { key: 'a20a60f5eed06fe0d625537d861831d2f8d3880c', "fill-rule": "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", "clip-rule": "evenodd" })))))));
    }
