...
const ScDialog = class {
    ...
    render() {
        return (h("div", { key: '17eafa7120b0967b09e1af3dfd3c0d74fef52d8c', part: "base", ref: el => (this.dialog = el), class: {
                'dialog': true,
                'dialog--open': this.open,
                'dialog--has-footer': this.hasFooter,
            }, onKeyDown: e => this.handleKeyDown(e) }, h("div", { key: 'bd84f19b1231f46f9f0c671899e97881ba3b3d0b', part: "overlay", class: "dialog__overlay", onClick: e => {
                e.preventDefault();
                e.stopImmediatePropagation();
                this.requestClose('overlay');
            }, ref: el => (this.overlay = el), tabindex: "-1" }), h("div", { key: 'bc8a115e02c4e5d9f4273e7680c8a9d34b1f7341', part: "panel", class: "dialog__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader || this.label, "aria-labelledby": !this.noHeader || 'title', ref: el => (this.panel = el), tabindex: "0" }, !this.noHeader && (h("header", { key: '2297c324c30dc806de95138c2e02b5de6a35412d', part: "header", class: "dialog__header" }, h("h2", { key: '4291c049b054398fff0722ac4d9dc766c5063237', part: "title", class: "dialog__title", id: "title" }, h("slot", { key: '017cde106e57465d95491b6ac28dc08db0b8b99d', name: "label" }, " ", this.label.length > 0 ? this.label : String.fromCharCode(65279), " ")), h("sc-button", { key: 'dd943d0debe713afc22edcdb37aec42f434b84d1', class: "dialog__close", type: "text", circle: true, part: "close-button", exportparts: "base:close-button__base", onClick: e => {
                e.preventDefault();
                e.stopImmediatePropagation();
                this.requestClose('close-button');
            } }, h("sc-icon", { key: 'c1a3e203f422fd7fe5fbe390fc04487dda850385', name: "x", label: wp.i18n.__('Close', 'surecart') })))), h("div", { key: '8923fa22e8b8373866d884d801cf4913948c6ea2', part: "body", class: "dialog__body" }, h("slot", { key: '229e3ccba52d77da0f80d3d94a7a10ffb6da3286' })), h("footer", { key: '390625073322e068b66097c4bc71a88751c41551', part: "footer", class: "dialog__footer" }, h("slot", { key: '0a0351ae2d121af78cf206d6cbdd697428d13d10', name: "footer" })))));
    }
