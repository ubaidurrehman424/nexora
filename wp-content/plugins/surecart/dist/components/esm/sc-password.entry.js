...
const ScPassword = class {
    ...
    render() {
        var _a;
        return (h("div", { key: '0b42f62649b6d2be9cb651f9adc23736452ddb85', class: "password" }, h("div", { key: 'd98cd75fe6111f9c47770c316b25abd851a29e4b' }, h("sc-input", { key: '6e0500b5d0c7b14864d233abfc30356f095601e4', ref: el => (this.input = el), label: this.label, help: this.help, autofocus: this.autofocus, placeholder: this.placeholder, showLabel: this.showLabel, size: this.size ? this.size : 'medium', type: "password", name: "password", value: this.value, required: this.required, disabled: this.disabled, onScInput: () => this.handleValidate() }), !!this.hintText && h("small", { key: '7772836b3ce35e37b0b6e5af454b64df381f87d0', class: "password__hint" }, this.hintText)), this.confirmation && (h("div", { key: '93c6df90696f9506b450005392bffdda0c4f324d' }, h("sc-input", { key: 'c96114ea74d05563d4d3a89d3ab785594d476493', ref: el => (this.confirmInput = el), label: (_a = this.confirmationLabel) !== null && _a !== void 0 ? _a : wp.i18n.__('Confirm Password', 'surecart'), help: this.confirmationHelp, placeholder: this.confirmationPlaceholder, size: this.size ? this.size : 'medium', type: "password", value: this.value, onScInput: () => this.handleVerification(), required: this.required, disabled: this.disabled }), !!this.verifyText && h("small", { key: '4b87cd6b61f935ef538543dfa117aaaffa1a6fe2', class: "password__hint" }, this.verifyText)))));
    }
