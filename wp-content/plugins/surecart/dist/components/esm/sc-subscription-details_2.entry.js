...
const ScSubscriptionDetails = class {
    ...
    render() {
        return (h("div", { key: 'f08cf709759b7e39f1ca4ca7821effe217de3a7d', class: "subscription-details" }, this.hasPendingUpdate && (h("div", { key: '64732d778e47446ddbf3ad2a0b2638c51a1298cb' }, h("sc-tag", { key: 'f52818f61af0fb6ca28c990eb0f3b777bd538c78', size: "small", type: "warning" }, wp.i18n.__('Update Scheduled', 'surecart')))), h("sc-flex", { key: 'fb12b13d81485a5adc9fbb31a53fb5df52dcc3b6', alignItems: "center", justifyContent: "flex-start" }, h("sc-text", { key: 'e5efcbb19d4865beeb8ade75364223c725d91b0b', "aria-label": wp.i18n.sprintf(
            /* translators: %s: plan name */
            wp.i18n.__('Plan name - %s', 'surecart'), this.renderName()), style: { '--font-weight': 'var(--sc-font-weight-bold)' } }, this.renderName()), this.renderActivations()), !this.hideRenewalText && h("div", { key: '8240d189a0a1aa19794c37c4a1b375973d85d012' }, this.renderRenewalText(), " "), h("slot", { key: 'c107bc068bb7ce438654496733f7ff19136eca24' }), h("sc-dialog", { key: '0e2bb45d1afcad937083715d96e8cc169b2d8bb3', label: wp.i18n.__('Activations', 'surecart'), onScRequestClose: () => (this.activationsModal = false), open: !!this.activationsModal }, h("sc-card", { key: 'e728cb330fb6c47e87c2c9fb0aaab4a7a9bda3d3', "no-padding": true, style: { '--overflow': 'hidden' } }, h("sc-stacked-list", { key: '02860a62f71e8a751d56b61e1755e5094d337e4e' }, (this.getActivations() || []).map(activation => {
        ...
        })))), this.showWarning() && (h("div", { key: '817ba0697161573612937902c6bd59448d4860a5' }, h("sc-tag", { key: '2485a9dda04a1e5e4b8151e3b985995091b202e0', type: "warning" }, h("div", { key: '4253b56809dea1a20447050bcd1bdbef3ca9d5c3', class: "subscription-details__missing-method" }, h("sc-icon", { key: 'd8cced468fc480983aa4b47ff364fee928defe94', name: "alert-triangle" }), wp.i18n.__('Payment Method Missing', 'surecart')))))));
    }
...
const ScSubscriptionStatusBadge = class {
    ...
    render() {
        return (h("sc-tag", { key: 'd030df07c6e46dd7ce8b02452d0432c3b7ce14bc', "aria-label": wp.i18n.sprintf(wp.i18n.__('Plan Status - %s', 'surecart'), this.getText()), type: this.getType() }, this.getText()));
    }
};
